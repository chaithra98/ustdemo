...
//	@Value("${com.ust.flightscheckin.itinerary.email.body}")
//	private String HTTP_LOCALHOST_8080_FLIGHTRESERVATION_RESERVATIONS ;
//	
//	private  String RESERVATION_REST_URL = HTTP_LOCALHOST_8080_FLIGHTRESERVATION_RESERVATIONS
